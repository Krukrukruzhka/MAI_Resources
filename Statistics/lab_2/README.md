...
Гистограмма показывает распределение оценок двух студентов по 5-балльной шкале. На графике визуально можно оценить различия в частотах получения различных оценок.
...
**Приложение:** Исходный код программы доступен в файле `main.py`